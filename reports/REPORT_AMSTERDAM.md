# Rapport d'Excellence Spectrale : amsterdam


## Synthèse de l'Interprétation Mathématique

### 1. Analyse du Rayon Spectral ($\rho = 4.5528$)
...
### 2. Amplification Maximale ($\sigma_{max} = 4.5528$)
...
- **Norme $H_\infty = 4.5528$** : Le pire cas entrée-sortie est purement topologique. SUMO va congestionner là où la structure l’impose.
- **Norme $H_2 = 167.2513$** : Très élevée par rapport à $H_\infty$. Le réseau **stocke de l'énergie** de perturbation, ce qui mène à une congestion diffuse et persistante.

### 4. Indice de Kreiss ($K = 30.4631$)
...
- **Rue Critique** : **-7043361#1** (ID: `-7043361#1`)
- **Poids Spectral** : 0.361099
