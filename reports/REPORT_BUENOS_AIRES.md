# Rapport d'Excellence Spectrale : buenos_aires


## Synthèse de l'Interprétation Mathématique

### 1. Analyse du Rayon Spectral ($\rho = 4.0000$)
...
### 2. Amplification Maximale ($\sigma_{max} = 4.1057$)
...
- **Norme $H_\infty = 4.1057$** : Le pire cas entrée-sortie est purement topologique. SUMO va congestionner là où la structure l’impose.
- **Norme $H_2 = 86.9425$** : Très élevée par rapport à $H_\infty$. Le réseau **stocke de l'énergie** de perturbation, ce qui mène à une congestion diffuse et persistante.

### 4. Indice de Kreiss ($K = 45.4313$)
...
- **Rue Critique** : **-21840967#1** (ID: `-21840967#1`)
- **Poids Spectral** : 0.536102
