# Rapport d'Excellence Spectrale : Feucherolles


## Synthèse de l'Interprétation Mathématique

### 1. Analyse du Rayon Spectral ($\rho = 3.8454$)
...
### 2. Amplification Maximale ($\sigma_{max} = 3.8749$)
...
- **Norme $H_\infty = 3.8749$** : Le pire cas entrée-sortie est purement topologique. SUMO va congestionner là où la structure l’impose.
- **Norme $H_2 = 34.1174$** : Très élevée par rapport à $H_\infty$. Le réseau **stocke de l'énergie** de perturbation, ce qui mène à une congestion diffuse et persistante.

### 4. Indice de Kreiss ($K = 84.1955$)
...
- **Rue Critique** : **-1150570069#1** (ID: `-1150570069#1`)
- **Poids Spectral** : 0.619899
