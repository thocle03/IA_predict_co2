# Rapport d'Excellence Spectrale : Lyon


## Synthèse de l'Interprétation Mathématique

### 1. Analyse du Rayon Spectral ($\rho = 4.1101$)
...
### 2. Amplification Maximale ($\sigma_{max} = 4.2510$)
...
- **Norme $H_\infty = 4.2510$** : Le pire cas entrée-sortie est purement topologique. SUMO va congestionner là où la structure l’impose.
- **Norme $H_2 = 134.1604$** : Très élevée par rapport à $H_\infty$. Le réseau **stocke de l'énergie** de perturbation, ce qui mène à une congestion diffuse et persistante.

### 4. Indice de Kreiss ($K = 21.5407$)
...
- **Rue Critique** : **-117093914#0** (ID: `-117093914#0`)
- **Poids Spectral** : 0.344821
