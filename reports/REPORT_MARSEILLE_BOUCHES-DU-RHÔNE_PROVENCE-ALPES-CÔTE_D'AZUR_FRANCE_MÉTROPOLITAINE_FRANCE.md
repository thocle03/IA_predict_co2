# Rapport d'Excellence Spectrale : Marseille


## Synthèse de l'Interprétation Mathématique

### 1. Analyse du Rayon Spectral ($\rho = 4.1486$)
...
### 2. Amplification Maximale ($\sigma_{max} = 4.1486$)
...
- **Norme $H_\infty = 4.1486$** : Le pire cas entrée-sortie est purement topologique. SUMO va congestionner là où la structure l’impose.
- **Norme $H_2 = 247.5116$** : Très élevée par rapport à $H_\infty$. Le réseau **stocke de l'énergie** de perturbation, ce qui mène à une congestion diffuse et persistante.

### 4. Indice de Kreiss ($K = 24.1661$)
...
- **Rue Critique** : **-453523278#0** (ID: `-453523278#0`)
- **Poids Spectral** : 0.193298
