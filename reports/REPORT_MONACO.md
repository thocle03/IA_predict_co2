# Rapport d'Excellence Spectrale : Monaco


## Synthèse de l'Interprétation Mathématique

### 1. Analyse du Rayon Spectral ($\rho = 3.6039$)
...
### 2. Amplification Maximale ($\sigma_{max} = 3.6039$)
...
- **Norme $H_\infty = 3.6039$** : Le pire cas entrée-sortie est purement topologique. SUMO va congestionner là où la structure l’impose.
- **Norme $H_2 = 46.2601$** : Très élevée par rapport à $H_\infty$. Le réseau **stocke de l'énergie** de perturbation, ce qui mène à une congestion diffuse et persistante.

### 4. Indice de Kreiss ($K = 62.5460$)
...
- **Rue Critique** : **-182694289#0** (ID: `-182694289#0`)
- **Poids Spectral** : 0.288265
