# Rapport d'Excellence Spectrale : neauphle le vieux


## Synthèse de l'Interprétation Mathématique

### 1. Analyse du Rayon Spectral ($\rho = 3.6955$)
...
### 2. Amplification Maximale ($\sigma_{max} = 3.6955$)
...
- **Norme $H_\infty = 3.6955$** : Le pire cas entrée-sortie est purement topologique. SUMO va congestionner là où la structure l’impose.
- **Norme $H_2 = 25.5539$** : Très élevée par rapport à $H_\infty$. Le réseau **stocke de l'énergie** de perturbation, ce qui mène à une congestion diffuse et persistante.

### 4. Indice de Kreiss ($K = 114.9919$)
...
- **Rue Critique** : **-227064589#1** (ID: `-227064589#1`)
- **Poids Spectral** : 0.338177
